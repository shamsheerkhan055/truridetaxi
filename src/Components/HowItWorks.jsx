...
import PlayBimg from '../assets/playB.png'
    ...
    <div className='outer-container'>
      <div className='inner-container'>
        <div className='heading'>
          ...
          <div>
            <img style={{width:'150px',height:'5px'}} src={barimg} alt='bar' />
          </div>
        </div>       
      </div>
      <div className='rectangle'>
        <img className='playB' src={PlayBimg} alt='play button' />
      </div>
      <div className='hiw'>
        <h1 style={{marginTop:'86px'}}>Problem & Solution <span>Demo Video</span></h1>
      </div>
      <div>
        <img style={{width:'500px',height:'5px',marginLeft:'375px'}} src={barimg} alt='bar' />
      </div>
      <div className='container-1'>
        <div className='left'>
          <div className='problem'>
            <img className='play' src={PlayBimg} alt='play button' />
          </div>
          <div><h3 style={{color:'#100062'}}>Users Problem Demo Video</h3></div>
        </div>
        <div className='middle'> 
          <img className='line' src={lineimg} alt='line' />
        </div>
        <div className='right'>
      ...
      <section className="contact-section"> 
        ...
        <div>
          <img style={{width:'200px',height:'5px',marginLeft:'520px'}} src={barimg} alt='bar' />
        </div>
